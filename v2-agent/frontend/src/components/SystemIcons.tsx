...
export const CircleStop = createSystemIcon("circle-stop", "stop_circle");
...
export const File = createSystemIcon("file", "draft");
...
export const FileWarning = createSystemIcon("file-warning", "file_alert");
export const Fingerprint = createSystemIcon("fingerprint", "fingerprint");
export const FolderOpen = createSystemIcon("folder-open", "folder_open");
...
export const XCircle = createSystemIcon("x-circle", "cancel");
