  ...
  const loadHistory = async ({
    ...
    try {
      ...
      if (!preserveOnError) {
        setHistory([]);
        setHistoryTotal(0);
        setHistoryFilterCounts({ all: 0, vlm: 0, mock: 0, "maps-only": 0, unknown: 0, real: 0, suspected: 0, highly: 0, unknownVerdict: 0, forensics: 0, provenance: 0, synthid: 0, watermark: 0 });
      }
