...
run_scp "$ALERT_WORKER_SERVICE_UNIT" "$REMOTE:/tmp/realguard-alert-worker.service"
run_scp "$ALERT_WATCHDOG_SERVICE_UNIT" "$REMOTE:/tmp/realguard-alert-watchdog.service"
run_scp "$ALERT_WATCHDOG_TIMER_UNIT" "$REMOTE:/tmp/realguard-alert-watchdog.timer"
...
run_scp "$RESTORE_DRILL_SERVICE_UNIT" "$REMOTE:/tmp/realguard-restore-drill.service"
run_scp "$RESTORE_DRILL_TIMER_UNIT" "$REMOTE:/tmp/realguard-restore-drill.timer"
run_scp "$SECURITY_AUDIT_SERVICE_UNIT" "$REMOTE:/tmp/realguard-security-audit-verify.service"
run_scp "$SECURITY_AUDIT_TIMER_UNIT" "$REMOTE:/tmp/realguard-security-audit-verify.timer"
