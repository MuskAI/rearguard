...
install -m 0600 -o root -g root /dev/null /var/lock/realguard-public-release.lock
install -m 0600 -o root -g root /dev/null /var/lock/realguard-public-gpu-deploy.lock
